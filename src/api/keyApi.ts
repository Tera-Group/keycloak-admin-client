...
export class KeyApi {
  ...
  public setApiKey(key: KeyApiApiKeys, value: string) {
    (this.authentications as any)[KeyApiApiKeys[key]].apiKey = value;
  }
   ...
   */
  public async realmKeysGet(
    realm: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{
    response: http.IncomingMessage;
    body: KeysMetadataRepresentation;
  }> {
    const localVarPath =
      this.basePath +
      '/{realm}/keys'.replace(
    ...
    if (realm === null || realm === undefined) {
      throw new Error(
        'Required parameter realm was null or undefined when calling realmKeysGet.'
      );
    }
