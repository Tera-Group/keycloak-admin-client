...
export enum ClientRegistrationPolicyApiApiKeys {}
...
export class ClientRegistrationPolicyApi {
  ...
  public setApiKey(key: ClientRegistrationPolicyApiApiKeys, value: string) {
    (this.authentications as any)[
      ClientRegistrationPolicyApiApiKeys[key]
    ].apiKey = value;
  }
   ...
   */
  public async realmClientRegistrationPolicyProvidersGet(
    realm: string,
    ...
    if (realm === null || realm === undefined) {
      throw new Error(
        'Required parameter realm was null or undefined when calling realmClientRegistrationPolicyProvidersGet.'
      );
    }
